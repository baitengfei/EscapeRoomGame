    ...
    execute: function () {
      ...
      _export("SceneManager", SceneManager = (_dec = ccclass('SceneManager'), _dec2 = property({
        ...
        LoadSceneFinish() {
          for (let i = 0; i < 4; i++) {
            let name = "S" + (i + 1);
            let sceneNode = this.mSceneParentNode.getChildByName(name);
            let sceneBase = sceneNode.getComponent(_crd && SceneBase === void 0 ? (_reportPossibleCrUseOfSceneBase({
              error: Error()
            }), SceneBase) : SceneBase);
...
//# sourceMappingURL=b04257b8e111261359fcf008991eb0379ca3f08c.js.map