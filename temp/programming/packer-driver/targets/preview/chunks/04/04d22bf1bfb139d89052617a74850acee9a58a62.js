  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", ResManager = ccclass(_class = (_class2 = class ResManager extends Component {
        ...
        LoadConfig(resName) {
          var listConfigs = [];
          var bundle = assetManager.getBundle("Config");
                ...
                for (var i = 2; i < mapArr.length; i++) {
                  ...
                  if (arr != null && mapArr[i] != "") {
                    ...
                    for (var index = 0; index < arr.length; index++) {
                      var arrName = listPropertys[index].trim();
...
//# sourceMappingURL=04d22bf1bfb139d89052617a74850acee9a58a62.js.map