    ...
    execute: function () {
      ...
      _export("WXAPI", WXAPI = (_dec = ccclass('WXAPI'), _dec(_class = (_class2 = class WXAPI extends (_crd && SingletonClass === void 0 ? (_reportPossibleCrUseOfSingletonClass({
        ...
        static share() {
          ...
          var randomImageIndex = (_crd && Tools === void 0 ? (_reportPossibleCrUseOfTools({
            error: Error()
        ...
        */
        ...
        static onShowGame(_callback) {
          ...
          var func = _res => {
            ...
            if (this.shareStartTimeSecond <= 0) {// 不处理
              ...
              // 判断转发成功与否，按时间处理
              var interval = (_crd && Tools === void 0 ? (_reportPossibleCrUseOfTools({
                error: Error()
        ...
        CreateAd(adUnitId, callBack) {
          ...
          for (var index = 0; index < WXAPI.ins().mListAds.length; index++) {
            var item = WXAPI.ins().mListAds[index];
...
//# sourceMappingURL=5eee88fe9e52b6261a0bbff2527942839dbcd2d7.js.map