    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property(Node), _dec(_class = (_class2 = (_class3 = class UIManager extends Component {
        ...
        getUIParentNode(type) {
          for (var index = 0; index < this.UINodeList.length; index++) {
            var info = this.UINodeList[index];
        ...
        ShowTips(content) {
          ...
          if (this.listTips.length <= 0) {
            ...
            if (this.tipsPrefab == null) {
              ...
              var path = cfg.name;
              var bundle = assetManager.getBundle("UI");
...
//# sourceMappingURL=ae074dc7e48e35d5b8ba1fc316be50505010ffc1.js.map